...
| Skill | Use when |
|---|---|
| [akinator](../skills/akinator/SKILL.md) | Touching a codebase in any way. The creed, the twelve-station loop, the knowledge taxonomy, and the routing table for every other skill |
