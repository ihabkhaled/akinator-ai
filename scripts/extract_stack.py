...
`skills/akinator-anti-gaming/SKILL.md`, it rots the moment a version moves, and
...
Usage:
    python scripts/extract_stack.py            # dry run
    python scripts/extract_stack.py --write    # write the map
    python scripts/extract_stack.py --check    # exit 1 if drifted
"""
...
GENERATOR = "scripts/extract_stack.py"
