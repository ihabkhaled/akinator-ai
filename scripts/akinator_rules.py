...
Usage:
    python scripts/akinator_rules.py graph
    python scripts/akinator_rules.py conflicts
    python scripts/akinator_rules.py caused <rule-id> <failure-fingerprint>
    python scripts/akinator_rules.py evolve <rule-id>
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "caused":
        ...
        print(f"draft the replacement with: "
              f"python scripts/akinator_rules.py evolve {args.rule_id}")
        return 0
