...
Generated by `scripts/extract_stack.py`. Edit the extractor, then regenerate with:
    python scripts/extract_stack.py --write
-->
...
- Extractor: `scripts/extract_stack.py`
- Regenerate with: `python scripts/extract_stack.py --write`
- Drift check: `python scripts/extract_stack.py --check` in CI.
